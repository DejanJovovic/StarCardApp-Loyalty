...
const Index = () => {
                ...
                <ScrollView contentContainerStyle={{flexGrow: 1, paddingTop: 50}}
                    ...
                    <View className="flex flex-col items-center justify-center">
                        ...
                        <Text className="mt-5 px-6 text-justify leading-relaxed"
                            ...
                            instead of just sharing your contact details will make everyone think about you long after
                            the
                            meeting,
                    ...
                    <View className="flex-col flex items-center justify-center m-3 p-1">
                        <Text className=" text-justify leading-relaxed text-lg font-semibold">EVERY NEW CONNECTION YOU
                            MAKE
                            COULD BE
                            THE ONE.</Text>
                    ...
                    <View className="flex-row mt-10 mb-10">
                        ...
                        <View className="flex-col ml-5 mb-10">
    ...
    return (
        <LinearGradient colors={[colors.gradientColor1, colors.gradientColor2]} className="flex-1">
            ...
            <ScrollView contentContainerStyle={{flexGrow: 1, paddingTop: 50}}
                        ref={scrollViewRef}>
                <Text className="mt-10">TEEEST</Text>
            </ScrollView>
        </LinearGradient>
    )
}
